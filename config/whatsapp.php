...
return [
    ...
    */
    ...
    'customer_services' => [
        ...
        'GIFT_CARDS' => env('WHATSAPP_CUSTOMER_SERVICE_GIFT_CARDS', true),
        'CORPORATE_BILLS' => env('WHATSAPP_CUSTOMER_SERVICE_CORPORATE_BILLS', true),
        'ZESA_CALCULATOR' => env('WHATSAPP_CUSTOMER_SERVICE_ZESA_CALCULATOR', true),
    ],
